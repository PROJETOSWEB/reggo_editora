	...
	<div id="Content">
		<div class="content_wrapper clearfix">
			...
			<div class="sections_group">
				...
				<div class="section center helpsections4">
					<div class="section_wrapper clearfix">
						<div class="items_group clearfix">
							<div class="column one column_column">
...
var retina = window.devicePixelRatio > 1 ? true : false;if(retina){var retinaEl = jQuery("#logo img");var retinaLogoW = retinaEl.width();var retinaLogoH = retinaEl.height();retinaEl.attr("src","images/logo-reggo.png").width(retinaLogoW).height(retinaLogoH)}});
//]]>
</script>
