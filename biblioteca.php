                                        ...
                                        <ul class="portfolio_group one-fourth isotope" style="margin-top: 50px;">
                                            ...
                                            while ($array_livros = mysql_fetch_array($executa_livro)) {
                                                ...
                                                <li class="portfolio-item literatura">
                                                    <div class="photo">
                                                        <a class="woocommerce-main-image" href="item-livro.php?liv=<?php echo $array_livros['livro_id']; ?>">
                                                            <img width="815"src="admin/imagens/livro/<?php echo $array_livros['img']; ?>" class="scale-with-grid wp-post-image" alt="<?php echo $array_livros['titulo']; ?>"/>
                                                        </a>
                                                    </div>
                                                </li>
