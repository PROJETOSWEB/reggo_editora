                                        ...
                                        <div class="widget-area clearfix">
                                            <aside id="text-3" class="widget widget_text">
                                                <div class="textwidget">
                                                    ...
                                                    <hr class="hr_left">
                                                    <h5>Reggo Editora</h5>
                                                    <h6>Av. Djalma Batista, 1661<br/>
                                                        Millenium Bussines Tower - Sala 1308<br/>  
                                                        CEP: 69050-010 |  Manaus-AM<br/>
                                                        <i class="icon-phone"></i> 92 3308-7327 | editora@reggo.com.br</h6>

                                                    <br/>

                                                    <a href="mailto:editora@reggo.com.br" class="button button_large button_icon"><i class="icon-mail-line"></i></a>
