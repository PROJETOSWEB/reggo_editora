            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="php/salva_noticia.php" method="POST" enctype='multipart/form-data'>
                        ...
                        </div>                         <div class="radios col-sm-7" style="margin-top: -20px;">                         <label for="exampleInputEmail1"><b>SELECIONE O GÊNERO DO LIVRO</b></label>                             <label class="label_radio" for="radio-01" style="float: left; padding-right: 25px;">                                 <input name="sample-radio" id="radio-01" value="1" type="radio" checked /> EMPRESA                             </label>                             <label class="label_radio" for="radio-02" style="float: left; padding-right: 25px;">                                 <input name="sample-radio" id="radio-02" value="1" type="radio" />LITERATURA                             </label>                             <label class="label_radio" for="radio-03" style="float: left;">                                 <input name="sample-radio" id="radio-03" value="1" type="radio" />TÉCNICO & ACADÊMICO                             </label>                         </div>                                                                           <div class="form-group col-sm-12">                         	<hr/>                         </div>                                                                  
